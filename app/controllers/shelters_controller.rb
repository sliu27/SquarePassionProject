class SheltersController < ApplicationController
  ...
  # GET /shelters/1.json
  def show
    @shelters = Shelter.find_by_zipcode(shelter_params[:zipcode])
    puts "HIIIII"
  end
  ...
  private
    ...
    def set_shelter
     # @shelter = Shelter.find(params[:id])
      @shelters = Shelter.all.select { |shelter| shelter.zipcode == "30313" }
    ...
    def shelter_params
      params.require(:shelter).permit(:name, :description, :address, :requirements, :zipcode)
    end
end
